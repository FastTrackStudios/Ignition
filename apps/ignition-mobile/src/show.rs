...
pub fn cues() -> CueList {
    // Cue and CueList have grown a lot of optional structure (numbers,
    // notes, appearance, triggers, wrap/restart). Spreading Default keeps
    // this demo honest about only setting what it means to set, and stops
    // it breaking every time a field is added.
    CueList {
        name: "Main".into(),
        cues: vec![
            Cue {
