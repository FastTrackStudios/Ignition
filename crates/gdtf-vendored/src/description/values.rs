...
impl Matrix {
    ...
    /// The matrix's rows, as a plain array — vendored accessor, not
    /// present upstream (the inner field is private with no getter at
    /// all in gdtf 0.3.0). See `PATCH-NOTES.md` at the crate root.
